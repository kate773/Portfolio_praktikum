...
| :-------------------- | :--------------------- |:---------------------------:|
| [Предсказание температуры плавления стали](https://github.com/kate773/Portfolio_praktikum/tree/main/Project%201) | Необходимо построить модель, которая предскажет температуру стали на производстве с целью оптимизации расходов | python, pandas, seaborn, catboost, lightgbm, scikit-learn |
